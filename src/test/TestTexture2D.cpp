...
namespace test {
		...
		m_TranslationView(glm::vec3(0, 0, 0))
	{
		...
		float position[] = {
		-50.0f, 50.0f, 0.0f, 1.0f,0.18f,0.6f,0.96f,1.0f,    //Squre point 0
		50.0f, 50.0f, 1.0f, 1.0f,0.18f,0.6f,0.96f,1.0f,		//Squre point 1 Duplicated point
		-50.0f, -50.0f, 0.0f, 0.0f,0.18f,0.6f,0.96f,10.f,	//Squre point 2 Duplicated point
		50.0f, -50.0f, 1.0f, 0.0f,0.18f,0.6f,0.96f,10.f,	//Squre point 3

		70.0f, 50.0f, 0.0f, 1.0f,1.0f,0.93f,0.24f,1.0f,     //Squre point 4
		170.0f, 50.0f, 1.0f, 1.0f,1.0f,0.93f,0.24f,1.0f,	//Squre point 5 Duplicated point
		70.0f, -50.0f, 0.0f, 1.0f,1.0f,0.93f,0.24f,1.0f,	//Squre point 6 Duplicated point
		170.0f, -50.0f, 1.0f, 1.0f,1.0f,0.93f,0.24f,1.0f	//Squre point 7
		}; //Define the data
		m_VAO = std::make_unique<VertexArray>();
		m_VertexBuffer = std::make_unique<VertexBuffer>(position, 8 * 8 * sizeof(float));
